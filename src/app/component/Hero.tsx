...
export default function Hero() {
  return (
    <div>
      ...
      <section className="home active absolute w-full h-full p-40 px-[9%] pb-8 overflow-hidden bg-bgcolor animate-show-content animation-section flex items-center gap-20 invisible opacity-0 2xl:pt-40 2xl:pb-8 2xl:px-[4%] max-768:flex-col-reverse max-768:justify-center max-768:gap-8">
        {/* Home Detail */}

        <div className="home-detail max-400:text-center">
          {/* Main Heading */}

          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight text-[5rem] text-whitecolor">
            MALIK <span className="text-maincolor">HUNAIN</span>
          </h1>

          {/* Sub Heading */}

          <h2 className="scroll-m-20 border-b pb-2 mt-4 text-5xl font-semibold tracking-tight first:mt-0 text-whitecolor">
            I'm a{" "}
            <span
          ...
          <p className="scroll-m-20 text-3xl font-medium tracking-tight my-4 mb-10 text-whitecolor">
          ...
          <div className="btn-sci flex items-center max-400:flex-col-reverse">
            <Link
              target="_blank"
              href="/CV/myCV.pdf"
              className="btn inline-block px-12 py-6 bg-maincolor border-[0.2rem] border-maincolor rounded-full shadow-[0_0_2em] text-[2rem] text-bgcolor transition-all duration-500 hover:bg-transparent hover:text-maincolor hover:ring-2 hover:ring-maincolor scroll-m-20 text-2xl font-semibold tracking-tight"
            >
              Download CV
            </Link>
          ...
          <div className="img-box relative w-[32vw] h-[32vw] rounded-full p-[0.5rem] flex justify-center items-center overflow-hidden max-768:w-[35rem] max-768:h-[35rem] max-600:w-[30rem] max-600:h-[30rem]">
            <div className="img-item relative w-full h-full bg-bgcolor rounded-full border-[0.01rem] border-bgcolor flex justify-center z-[1] overflow-hidden">
              <Image
                src="/images/home.png"
                alt="no-image"
                className="absolute top-[3rem] block w-[85%] object-cover mix-blend-lighten"
                width={1200}
                height={1200}
              />
            </div>
